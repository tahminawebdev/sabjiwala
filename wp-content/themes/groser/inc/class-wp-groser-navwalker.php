<?php
/**
 *groser Bootstrap Navwalker
 *
 * @packagegroser-Bootstrap-Navwalker
 *
 */

// Check if Class Exists.
if ( ! class_exists( 'Groser_Bootstrap_Navwalker' ) ) {
	/**
	 * Groser_Bootstrap_Navwalker class.
	 */
	class Groser_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" class="nav-link" title="' . esc_attr__( 'Add a menu', 'groser' ) . '">' . esc_html__( 'Add a menu', 'groser' ) . '</a></li>';
			$fallback_output .= '</ul>';
