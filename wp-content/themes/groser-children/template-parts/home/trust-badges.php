...
$badges = [
    [
        'title' => __( 'Fresh Daily', 'groser-children' ),
        'sub'   => __( 'Quality Guaranteed', 'groser-children' ),
    ...
    [
        'title' => __( 'Fast UK Delivery', 'groser-children' ),
        'sub'   => __( 'Same-Day Available', 'groser-children' ),
    ...
    [
        'title' => __( 'Secure Checkout', 'groser-children' ),
        'sub'   => __( '100% Protected', 'groser-children' ),
    ...
    [
        'title' => __( 'Easy Returns', 'groser-children' ),
        'sub'   => __( 'Hassle-Free', 'groser-children' ),
...
?>
<section class="sjw-trust">
    <div class="sjw-trust__inner">
        <?php foreach ( $badges as $badge ) : ?>
            <div class="sjw-trust__item">
                <div class="sjw-trust__icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <?php echo $badge['icon']; // phpcs:ignore WordPress.Security.EscapeOutput ?>
                    </svg>
                </div>
                <div>
                    <p class="sjw-trust__title"><?php echo esc_html( $badge['title'] ); ?></p>
                    <?php if ( $badge['sub'] ) : ?>
                        <p class="sjw-trust__sub"><?php echo esc_html( $badge['sub'] ); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        <?php endforeach; ?>
